...
def demo(args):
    ...
    for (imfile1, imfile2) in tqdm(list(zip(left_images, right_images))):
        ...
        plt.imsave(output_directory / f"{file_stem}_dynamic_onnx.png", disp.squeeze(), cmap='jet')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--onnx_model', default='./onnx_model/FFLONetDynamic.onnx', help='path to model')
